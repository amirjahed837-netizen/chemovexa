export const en = {
  ...
  pages: {
    ...
    mechanisms: {
      ...
      expand: "Expand",
      collapse: "Collapse",
      showAll: "Show all {count} mechanisms",
      showTopic: "Show {count} in {label}",
      filterByTopic: "Filter mechanisms by topic",
      filteredCount: "Showing {count} of {total} mechanisms",
      diagramCollapse: "Collapse mechanism diagram",
      diagramExpand: "Expand mechanism diagram",
      stepsLabel: "Steps",
